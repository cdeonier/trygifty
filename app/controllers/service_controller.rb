class ServiceController < ApplicationController
  ...
  def register
    @pass = Pass.find_by_serial_number(params[:serial_number]).first
    ...
    @device = Device.find_by_device_library_identifier(params[:device_library_identifier]).first_or_initialize
